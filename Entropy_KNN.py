...
#test_data_set = pd.read_csv("TEST_DATA_SET3.csv")
#test_data_set=test_data_set[["Col0","Col1","Col2","Col3","Col4"]]
#lst=[3]*len(test_data_set)
#test_data_set["Output"]=lst

#print(test_data_set)


#x_test=test_data_set.drop("Output",axis="columns")
#y_test=test_data_set.Output
